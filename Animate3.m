...
function cview = Animate2( o1,o2,o3,om4,axs,cview )
...
[x1, y1, z1] = sphere;
axis(axs,[-12 12 -12 12 -5 20]);
% hold on;
% rotate3d on;

% Dedo A

f1A = mesh(axs,x+xa,y+ya,z*l1+za);
rotate(f1A,[0 1 0],rad2deg(o1(1)),[xa ya za]);
f2A = mesh(axs,x + vecdAf1(1),y + vecdAf1(2),z*l2 + vecdAf1(3));
rotate(f2A,[0 1 0],rad2deg(o1(1)+o1(2)),[vecdAf1(1) vecdAf1(2) vecdAf1(3)]);
f3A = mesh(axs,x + vecdAf2(1),y + vecdAf2(2),z*l3 + vecdAf2(3));
rotate(f3A,[0 1 0],rad2deg(o1(1)+o1(2)+o1(3)),[vecdAf2(1) vecdAf2(2) vecdAf2(3)]);
pA = mesh(axs,x1*0.5+vecdAf3(1),y1*0.5+vecdAf3(2),z1*0.5+vecdAf3(3));

% Dedo B

f4B = mesh(axs,x + xb,y + yb,z*l4b + zb);
rotate(f4B,[1 0 0],rad2deg(om4),[xb yb zb]);
f1B = mesh(axs,x + vecdBl4(1),y + vecdBl4(2),z*l1 + vecdBl4(3));
...
f2B = mesh(axs,x + vecdBf1(1),y + vecdBf1(2),z*l2 + vecdBf1(3));
...
f3B = mesh(axs,x + vecdBf2(1),y + vecdBf2(2),z*l3 + vecdBf2(3));
...
pB = mesh(axs,x1*0.5+vecdBf3(1),y1*0.5+vecdBf3(2),z1*0.5+vecdBf3(3));

% Dedo C

f4C = mesh(axs,x + xc,y + yc,z*l4c + zc);
rotate(f4C,[1 0 0],rad2deg(-om4),[xc yc zc]);
f1C = mesh(axs,x + vecdCl4(1),y + vecdCl4(2),z*l1 + vecdCl4(3));
...
f2C = mesh(axs,x + vecdCf1(1),y + vecdCf1(2),z*l2 + vecdCf1(3));
...
f3C = mesh(axs,x + vecdCf2(1),y + vecdCf2(2),z*l3 + vecdCf2(3));
...
pC = mesh(axs,x1*0.5+vecdCf3(1),y1*0.5+vecdCf3(2),z1*0.5+vecdCf3(3));
