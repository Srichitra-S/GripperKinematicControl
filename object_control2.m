...
while true
    ...
    er = [ dp12'*dp12 ; dp23'*dp23 ; dp31'*dp31 ]/2;
    ...
    erd = [ DELTA(1,:)*DELTA(1,:)' ; DELTA(2,:)*DELTA(2,:)' ; DELTA(3,:)*DELTA(3,:)' ]/2; % relative squared reference
    ...
    D = [ dp12' zeros(1,6) ; zeros(1,3) dp23' zeros(1,3) ; zeros(1,6) dp31' ];
